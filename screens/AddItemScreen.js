...
const AddItemScreen = () => {
  ...
  const submitPost = async () => {
    ...
    firestore()
    .collection("storesList").doc(storeName)
    .set({
      userId: user.uid,
      store: store,
      storeName: storeName,
    ...
    .catch((error) => {
      console.log('Something went wrong with added store to firestore.', error);
    });
  }
    ...
    <View style={styles.container}>
      ...
      <View >
        ...
        <TextInput
          ...
          numberOfLines={1}
          value={store}
          onChangeText={(contentstore) => setStoreName(contentstore)}
        />
        <TextInput
          style={{width:300,marginBottom:5, borderWidth:1,borderRadius:15,borderColor:"#000",justifyContent:"center",alignItems:"center"}}
          ...
          numberOfLines={2}
          value={storeAddress}
          onChangeText={(contentaddress) => setStoreAddress(contentaddress)}
        />
         <TextInput
          style={{width:300,marginBottom:5, borderWidth:1,borderRadius:20,borderColor:"#000",justifyContent:"center",alignItems:"center"}}
          placeholder="Store Name"
          multiline

          numberOfLines={4}
          value={storeName}
          onChangeText={(contentstore) => setStore(contentstore)}
        />
        {uploading ? (
          <View>
